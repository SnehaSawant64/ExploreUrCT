        ...
        switch(v.getId())
        {
            case R.id.B_search:
                if(a.equals("resto")){
                    ...
                    Toast.makeText(MapsActivity.this, "Showing Nearby Restaurants"+url, Toast.LENGTH_SHORT).show();
                    break;

                }else if(a.equals("hospital")){
                    mMap.clear();
